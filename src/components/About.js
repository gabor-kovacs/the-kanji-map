		...
		<>
			<AboutWrapper>
				...
				<p>
					...
					nodes have the same onyomi it is displayed over the link. Nodes are colored based on type:{' '}
					<svg style={{ display: 'inline', height: ' 12px' }} viewBox="0 0 100 100">
				...
				<p>
					...
					<StyledLink href="http://www.chise.org/ids/index.html" target="_blank" rel="noreferrer">
						CHISE project
					</StyledLink>
				...
				<p>
					...
					<StyledLink href="https://glyphwiki.org/" target="_blank" rel="noreferrer">
						GlyphWiki
					</StyledLink>
					.
				</p>
				...
				<p>
					...
					<StyledLink target="_blank" href="https://github.com/parsimonhi/animCJK" rel="noreferrer">
						animCJK
					</StyledLink>{' '}
				...
				<p>
					...
					<StyledLink target="_blank" href="https://jisho.org/about " rel="noreferrer">
						dicionaries
					</StyledLink>{' '}
					and{' '}
					<StyledLink target="_blank" href="https://kanjialive.com/" rel="noreferrer">
						Kanji alive
					</StyledLink>{' '}
				...
				<p>
					Graph is created by{' '}
					<StyledLink target="_blank" href="https://github.com/vasturiano/react-force-graph" rel="noreferrer">
						react-force-graph
					</StyledLink>{' '}
					and{' '}
					<StyledLink target="_blank" href="https://github.com/vasturiano/three-spritetext" rel="noreferrer">
						three-spritetext
					</StyledLink>{' '}
					released under MIT.
				</p>
				<p>
					...
					<StyledLink target="_blank" href="https://github.com/ChenYuHo/handwriting.js" rel="noreferrer">
						handwriting.js
					</StyledLink>{' '}
					released under MIT.
				</p>
				...
				<p>
					...
					<StyledLink target="_blank" href="https://github.com/gabor-kovacs/the-kanji-map" rel="noreferrer">
